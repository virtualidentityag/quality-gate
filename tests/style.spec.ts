...
describe('style linting', (): void => {
  ...
  testProject(
    ...
    [
      `./${PROJECTS_PATH}/style-fail/wrongName.css: File path is error-prone. Use kebab-case for folder names and files. (@biotope-quality-gate/filenames)`,
      `./${PROJECTS_PATH}/style-fail/wrongName.scss: File path is error-prone. Use kebab-case for folder names and files. (@biotope-quality-gate/filenames)`,
