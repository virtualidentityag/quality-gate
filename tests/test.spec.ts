...
describe('test linting', (): void => {
  ...
  testProject(
    ...
    [
      ...
      `./${PROJECTS_PATH}/test-fail/index.my-spec.ts [2, 10]: There should be no space after this paren. (space-in-parens)`,
      ...
      `./${PROJECTS_PATH}/test-fail/index.my-spec.ts [6, 15]: Multiple spaces found before 'toBe'. (no-multi-spaces)`,
    ],
  );
